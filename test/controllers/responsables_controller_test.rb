...
class ResponsablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create responsable" do
    assert_difference('Responsable.count') do
      post responsables_url, params: { responsable: { cedula: @responsable.cedula, direccion: @responsable.direccion, nombre: @responsable.nombre, telefono: @responsable.telefono } }
    end
  ...
  test "should update responsable" do
    patch responsable_url(@responsable), params: { responsable: { cedula: @responsable.cedula, direccion: @responsable.direccion, nombre: @responsable.nombre, telefono: @responsable.telefono } }
