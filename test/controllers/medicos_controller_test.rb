...
class MedicosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medico" do
    assert_difference('Medico.count') do
      post medicos_url, params: { medico: { direccion_residencia: @medico.direccion_residencia, especialidad_id: @medico.especialidad_id, nombre: @medico.nombre, telefono: @medico.telefono } }
    end
  ...
  test "should update medico" do
    patch medico_url(@medico), params: { medico: { direccion_residencia: @medico.direccion_residencia, especialidad_id: @medico.especialidad_id, nombre: @medico.nombre, telefono: @medico.telefono } }
