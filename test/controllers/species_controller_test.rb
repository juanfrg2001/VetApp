...
class SpeciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create species" do
    assert_difference('Species.count') do
      post species_index_url, params: { species: { edad: @species.edad, esterilizado: @species.esterilizado, genero: @species.genero, raza: @species.raza } }
    end
  ...
  test "should update species" do
    patch species_url(@species), params: { species: { edad: @species.edad, esterilizado: @species.esterilizado, genero: @species.genero, raza: @species.raza } }
