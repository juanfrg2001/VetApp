...
class EspecialidadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create especialidad" do
    assert_difference('Especialidad.count') do
      post especialidads_url, params: { especialidad: { nombre: @especialidad.nombre, sede_id: @especialidad.sede_id } }
    end
  ...
  test "should update especialidad" do
    patch especialidad_url(@especialidad), params: { especialidad: { nombre: @especialidad.nombre, sede_id: @especialidad.sede_id } }
