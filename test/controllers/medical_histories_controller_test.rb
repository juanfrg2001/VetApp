...
class MedicalHistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medical_history" do
    assert_difference('MedicalHistory.count') do
      post medical_histories_url, params: { medical_history: { cdiagnostico: @medical_history.cdiagnostico, diaries_id: @medical_history.diaries_id, fecha_consulta: @medical_history.fecha_consulta, motivo_consulta: @medical_history.motivo_consulta, tratamiento_seguir: @medical_history.tratamiento_seguir } }
    end
  ...
  test "should update medical_history" do
    patch medical_history_url(@medical_history), params: { medical_history: { cdiagnostico: @medical_history.cdiagnostico, diaries_id: @medical_history.diaries_id, fecha_consulta: @medical_history.fecha_consulta, motivo_consulta: @medical_history.motivo_consulta, tratamiento_seguir: @medical_history.tratamiento_seguir } }
