...
class ResponsiblesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create responsible" do
    assert_difference('Responsible.count') do
      post responsibles_url, params: { responsible: { cedula: @responsible.cedula, direccion: @responsible.direccion, nombre: @responsible.nombre, telefono: @responsible.telefono } }
    end
  ...
  test "should update responsible" do
    patch responsible_url(@responsible), params: { responsible: { cedula: @responsible.cedula, direccion: @responsible.direccion, nombre: @responsible.nombre, telefono: @responsible.telefono } }
