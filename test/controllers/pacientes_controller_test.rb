...
class PacientesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paciente" do
    assert_difference('Paciente.count') do
      post pacientes_url, params: { paciente: { responsable_id: @paciente.responsable_id, sede_id: @paciente.sede_id, tipo_especie_id: @paciente.tipo_especie_id } }
    end
  ...
  test "should update paciente" do
    patch paciente_url(@paciente), params: { paciente: { responsable_id: @paciente.responsable_id, sede_id: @paciente.sede_id, tipo_especie_id: @paciente.tipo_especie_id } }
