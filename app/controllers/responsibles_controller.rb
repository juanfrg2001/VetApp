class ResponsiblesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @responsible.save
        format.html { redirect_to responsible_url(@responsible), notice: "Responsible was successfully created." }
  ...
  private
    ...
    def responsible_params
      params.require(:responsible).permit(:nombre, :cedula, :telefono, :direccion)
    end
end
